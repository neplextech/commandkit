...
<GenerationInfo sourceFile="packages/commandkit/src/app/commands/MessageCommandParser.ts" sourceLine="38" packageName="commandkit" />
...
<MemberInfo kind="method" type={`(message: Message, prefix: string[] | RegExp, schema: (command: string) =&#62; <a href='/docs/api-reference/commandkit/types/message-command-options-schema#messagecommandoptionsschema'>MessageCommandOptionsSchema</a>) => MessageCommandParser`}   />
...
<MemberInfo kind="method" type={`() => <a href='/docs/api-reference/commandkit/interfaces/parsed-message-command#parsedmessagecommand'>ParsedMessageCommand</a>`}   />

...
By utilizing square brackets for folder names (e.g. `[settings]`), CommandKit recognizes the folder as a **Root Command** or **Subcommand Group**, merging everything inside into a single subcommand tree natively sent to Discord.
...
This transforms into the slash commands:

- `/settings notifications enable`
- `/settings notifications disable`
- `/settings options`

Any file named correctly (i.e. does not start with `_` or `+`) inside these structures operates as a leaf subcommand.

# 02 migration plan template

## Purpose

Provide a phased migration template with parity checks.
...
```txt
Follow the patterns in this reference and adapt names/options to project context.
```

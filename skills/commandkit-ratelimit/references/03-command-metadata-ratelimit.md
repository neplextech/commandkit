# 03 command metadata ratelimit

## Purpose

Show per-command policy overrides through metadata.

## When to use

Use when specific commands need tighter or looser limits than global defaults.
